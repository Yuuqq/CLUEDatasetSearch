# Chinese AI Data Hub - Datasets Overview

> **Quick lookup table** for all datasets in this Chinese AI Data Hub.

This file provides a high-level index of datasets organized by modern AI workflow categories.

**Note**: This overview is automatically maintained. When you add or update datasets in `data/`, the table will be regenerated via GitHub Actions.
...
| Chinese Books Corpus 2025 | - | ~500GB | llm-pretraining, long-context-pretraining | 2026-07-08 | active | High-quality Chinese books corpus (2025) |
...
| Qwen Instruct 2025 | [Qwen/Qwen-Instruct-2025-CN](https://huggingface.co/datasets/Qwen/Qwen-Instruct-2025-CN) | ~2M high-quality instructions | sft, reasoning-llm, agent | 2026-07-08 | active | High-quality Chinese instruction data from Qwen team (2025) |
...
| DPO Chinese Preference 2026 | [OpenChineseLLM/DPO-Chinese-2026](https://huggingface.co/datasets/OpenChineseLLM/DPO-Chinese-2026) | ~150k preference pairs | dpo, alignment | 2026-07-08 | active | Latest DPO-optimized Chinese preference data (2026) |
...
| Long-Context SFT Chinese 2026 | [ChineseLLM/Long-SFT-2026](https://huggingface.co/datasets/ChineseLLM/Long-SFT-2026) | ~500k long-context instructions | long-context-llm, rag-long-context | 2026-07-08 | active | High-quality long-context SFT data (up to 128k tokens) |
...
| AgentBench Chinese 2026 | [AgentEval/AgentBench-Chinese-2026](https://huggingface.co/datasets/AgentEval/AgentBench-Chinese-2026) | Multiple agent tasks | agent, tool-use-evaluation | 2026-07-08 | active | Chinese Agent & tool-use evaluation benchmark (2026) |
...
| Chinese Financial Domain 2025 | [FinancialAI/Finance-Chinese-2025](https://huggingface.co/datasets/FinancialAI/Finance-Chinese-2025) | ~300k financial documents + QA | finance-llm, rag-finance | 2026-07-08 | active | High-quality Chinese financial domain data (2025) |
...
- This table is **automatically regenerated** using the script in `scripts/generate_datasets_md.py` via GitHub Actions.
